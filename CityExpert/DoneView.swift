...
open class DoneView: UIView {
    ...
    fileprivate func initialize() {
        ...
        self.lineLayer.strokeColor = UIColor.white.cgColor //yh
        
        // Generate blur view
        var blurView: UIView
        
        blurView = UIView()
        blurView.layer.backgroundColor = UIColor(red: 0.718, green: 0.102, blue: 0.227, alpha: 0.8).cgColor
      ...
      /*  if #available(iOS 8.0, *) {
           // blurView = UIVisualEffectView(effect: UIBlurEffect(style: .ExtraLight))
            ...
            blurView = UIView()
            blurView.layer.backgroundColor = UIColor.whiteColor().CGColor
           // blurView.backgroundColor = UIColor(white: 1, alpha: 0.8)
          //  blurView.backgroundColor = UIColor(red: 0.718, green: 0.102, blue: 0.227, alpha: 0.5)
